...
class MemberSqlQuery {
    ...
    public static final String GET_BY_MEMBER_CODE_QUERY = """
        SELECT
        member_id, member_code, member_name, refresh_token, total_solved_count, total_correct_count, completion_rate, total_learning_time, sign_up_time, status, bio 
        FROM MEMBER
        WHERE member_code = ?
    """
    ...
    public static final String FIND_BY_MEMBER_ID_QUERY = """
        SELECT
        member_id, member_code, member_name, refresh_token, total_solved_count, total_correct_count, completion_rate, total_learning_time, sign_up_time, status, bio 
        FROM MEMBER 
        WHERE member_id = ?
    ...
    public static final String UPDATE_BY_ID = """
        UPDATE MEMBER
        SET member_code = ?, member_name = ?, refresh_token = ?, total_solved_count = ?, total_correct_count = ?, completion_rate = ?, total_learning_time = ?, sign_up_time = ?, status = ?, bio = ?
        WHERE member_id = ?
    """
