...
import static com.m9d.sroom.youtube.YoutubeUtil.REQUEST_METHOD_GET;
import static com.m9d.sroom.youtube.YoutubeUtil.YOUTUBE_REQUEST_CONTENT_TYPE;

@Service
@Slf4j
public class HttpUrlConnectionServiceV2 implements YoutubeApiV2 {
    ...
    public HttpUrlConnectionServiceV2(Gson gson) {
        this.gson = gson;
    }
